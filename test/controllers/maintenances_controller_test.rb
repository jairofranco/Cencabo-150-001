...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post maintenances_url, params: { maintenance: { descripcion: @maintenance.descripcion, nombre: @maintenance.nombre, talleres: @maintenance.talleres } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { descripcion: @maintenance.descripcion, nombre: @maintenance.nombre, talleres: @maintenance.talleres } }
