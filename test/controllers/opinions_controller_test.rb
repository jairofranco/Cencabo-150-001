...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { asunto: @opinion.asunto, fecha: @opinion.fecha, texto: @opinion.texto, tipo: @opinion.tipo, usuario: @opinion.usuario } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { asunto: @opinion.asunto, fecha: @opinion.fecha, texto: @opinion.texto, tipo: @opinion.tipo, usuario: @opinion.usuario } }
